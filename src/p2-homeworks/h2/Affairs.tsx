...
function Affairs(props: AffairsPropsType) {
    ...
    return (
        <div>
            ...
            <button onClick={setHigh} className={s.high1}>High</button>
            <button onClick={setMiddle}className={s.middle1}>Middle</button>
            <button onClick={setLow} className={s.low1}>Low</button>
        </div>
    )
}
